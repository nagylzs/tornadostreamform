...
class TemporaryFileStreamedPart(StreamedPart):
    ...
    def get_file(self):
        """Return the temporary file associated with the part."""
        return self.f_out
...
class MultiPartStreamer:
    ...
    def __init__(self, total, tmp_dir=None):
        ...
        :param tmp_dir: Default directory to store temporary files.
        """
        self.buf = b""
        self.dlen = None
        self.delimiter = None
        self.in_data = False
        self.headers = []
        self.parts: typing.List[StreamedPart] = []
        self.total = total
        self.received = 0
    ...
    def create_part(self, headers) -> StreamedPart:
        ...
        """
        return TemporaryFileStreamedPart(self, headers, self.tmp_dir)
    ...
    def get_parts_by_name(self, part_name) -> typing.List[StreamedPart]:
        """Get a parts by name.
    ...
    def get_nonfile_parts(self) -> typing.List[StreamedPart]:
